FROM ubuntu:latest
# Based on marcelocg/phoenix-docker(https://github.com/marcelocg/phoenix-docker)
...
RUN apt-get install -y curl wget git make sudo \
    # From Phoenix Documentation https://hexdocs.pm/phoenix/installation.html#content
    && wget https://packages.erlang-solutions.com/erlang-solutions_1.0_all.deb && dpkg -i erlang-solutions_1.0_all.deb \
    && apt-get update && rm erlang-solutions_1.0_all.deb \
...
# Install the Phx(Latest 1.3.0) archive
